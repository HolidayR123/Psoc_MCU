...
/* Pin_sw */
#define Pin_sw_0_DRIVEMODE CY_GPIO_DM_PULLUP
#define Pin_sw_0_INBUF_ENABLED 1u
#define Pin_sw_0_INIT_DRIVESTATE 1u
#define Pin_sw_0_INIT_MUXSEL 0u
#define Pin_sw_0_INPUT_SYNC 2u
#define Pin_sw_0_INTERRUPT_MODE CY_GPIO_INTR_FALLING
#define Pin_sw_0_NUM 4u
#define Pin_sw_0_PORT GPIO_PRT0
#define Pin_sw_0_SLEWRATE CY_GPIO_SLEW_FAST
#define Pin_sw_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define Pin_sw_DRIVEMODE CY_GPIO_DM_PULLUP
#define Pin_sw_INBUF_ENABLED 1u
#define Pin_sw_INIT_DRIVESTATE 1u
#define Pin_sw_INIT_MUXSEL 0u
#define Pin_sw_INPUT_SYNC 2u
#define Pin_sw_INTERRUPT_MODE CY_GPIO_INTR_FALLING
#define Pin_sw_NUM 4u
#define Pin_sw_PORT GPIO_PRT0
#define Pin_sw_SLEWRATE CY_GPIO_SLEW_FAST
#define Pin_sw_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS

/* Pin_led */
#define Pin_led_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define Pin_led_0_INBUF_ENABLED 0u
#define Pin_led_0_INIT_DRIVESTATE 0u
#define Pin_led_0_INIT_MUXSEL 0u
#define Pin_led_0_INPUT_SYNC 2u
#define Pin_led_0_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define Pin_led_0_NUM 1u
#define Pin_led_0_PORT GPIO_PRT7
#define Pin_led_0_SLEWRATE CY_GPIO_SLEW_FAST
#define Pin_led_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define Pin_led_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define Pin_led_INBUF_ENABLED 0u
#define Pin_led_INIT_DRIVESTATE 0u
#define Pin_led_INIT_MUXSEL 0u
#define Pin_led_INPUT_SYNC 2u
#define Pin_led_INTERRUPT_MODE CY_GPIO_INTR_DISABLE
#define Pin_led_NUM 1u
#define Pin_led_PORT GPIO_PRT7
#define Pin_led_SLEWRATE CY_GPIO_SLEW_FAST
#define Pin_led_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
